#!/bin/bash
#
# Developed by Fred Weinhaus 11/9/2012 .......... revised 1/14/2013
#
...
trap "rm -f $tmpA1 $tmpA2 $tmpB1 $tmpB2 $tmpL; exit 0" 0
...
# convert hue in degrees to hue in percent for IM usage
