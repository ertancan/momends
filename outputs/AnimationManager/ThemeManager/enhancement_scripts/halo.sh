#!/bin/bash
#
# Developed by Fred Weinhaus 2/6/2009 .......... revised 7/16/2011
#
...
trap "rm -f $tmpA1 $tmpB1 $tmp1 $tmp2 $tmp3; exit 0" 0
...
if convert -quiet -regard-warnings "$infile" +repage $setcspace "$tmpA1"
	then
	: ' Do Nothing '
else
...
convert $tmpA1 $tmp1 -composite $outfile
