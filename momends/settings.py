...
DATABASES = {
    'default': {
        ...
        'NAME': '/Users/goktan/DEPO/Dropbox/workspace/momends/db.sqlite', # Or path to database file if using sqlite3.
...
TEMPLATE_DIRS = ('/Users/goktan/DEPO/Dropbox/workspace/momends/templates',)
